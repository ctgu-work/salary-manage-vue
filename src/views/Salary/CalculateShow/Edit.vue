<template>
  ...
  >
    ...
    >
      <!-- 岗位名称，岗位编制 部门名称 岗位类型 -->
      <el-form-item label="公式ID" prop="formulaId">
        <el-input v-model="form.formulaId"></el-input>
      </el-form-item>

      <el-form-item label="公式名" prop="formulaName">
        <el-input v-model="form.formulaName"></el-input>
      </el-form-item>

      <el-form-item label="公式计算百分比" prop="formulaPercentage">
  ...
  data() {
    return {
      ...
      rules: {
        ...
        formulaPercentage:RequiredAndFloat3,
        url: [Required, Url],
