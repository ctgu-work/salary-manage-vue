  ...
  <div>
    ...
    <div>
      <el-table ref="filterTable" :data="tableData" style="width: 100%">
        <el-table-column prop="departTypeId" :label="this.$i18n.t('departType.departmentType.departTypeId')" sortable></el-table-column>
        <el-table-column prop="type" :label="this.$i18n.t('departType.departmentType.type')"></el-table-column>
        <el-table-column>
...
import { findDepartmentType, DepartmentTypedelete } from "@/api/BasicManage/departType.js";
export default {
  ...
  methods: {
    ...
    handleDelete(index,row) {
      DepartmentTypedelete({ id: row.departTypeId })
